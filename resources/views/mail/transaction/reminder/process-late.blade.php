                            ...
                            <tbody>
                                <tr>
                                    <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size: 0px;">
                                        <a target="_blank">
                                            <img src="{{ asset('images/undraw_newspaper_k72w.png') }}" alt style="display: block;" width="100">
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="center" class="esd-block-text es-p10t es-p20b">
                                            <p>Hai {{ $data->customer->name }}, berdasarkan data yang ada di sistem kami, kamu memiliki transaksi yang sudah/akan melewati batas tanggal sewa. Informasi transaksi dapat kamu lihat di bawah ini</p>
                                        </td>
                                    </tr>
                                    <tr>
