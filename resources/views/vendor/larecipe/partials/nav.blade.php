        ...
        <div class="block mx-4 flex items-center">
            ...
            @auth
                ...
                <larecipe-dropdown>
                    ...
                    <template slot="list">
                        <a href="{{ route('adm.index') }}" class="py-2 px-4 text-white bg-primary inline-flex"><i class="fa fa-dashboard mr-2"></i> Dashboard</a>
                        <form action="/logout" method="POST">
                            {{ csrf_field() }}

                            <button type="submit" class="py-2 px-4 text-white bg-danger inline-flex w-full"><i class="fa fa-power-off mr-2"></i> Logout</button>
                        </form>
                    </template>
                </larecipe-dropdown>
                {{-- /account --}}
