@extends('layouts.adm.app', [
    'wsecond_title' => 'Kategori: Tambah Baru',
    'sidebar_menu' => 'category',
    'sidebar_submenu' => null,
    'wheader' => [
        'header_title' => 'Kategori: Tambah Baru',
        'header_breadcrumb' => [
            [
                'title' => 'Dashboard',
                'is_active' => false,
...
@section('content')
<form class="card" method="POST" action="{{ route('adm.product.category.store') }}" enctype="multipart/form-data">
    @csrf

    <div class="card-header">
        <h3 class="card-title">Kategori: Tambah Baru</h3>
    ...
    <div class="card-body">
        <div class="form-group">
            <label>Nama</label>
            <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Nama Kategori" name="name" id="input-name" value="{{ old('name') }}" required>
            @error('name')
        ...
        <div class="form-group">
            ...
            <textarea class="ckeditor d-none @error('description') is-invalid @enderror" name="description" id="input-description" placeholder="Deskripsi mengenai kategori akan berada disini...">{!! old('description') !!}</textarea>
            @error('description')
