@extends('layouts.adm.app', [
    'wsecond_title' => 'Produk Serial Number: Edit Data',
    'sidebar_menu' => 'product',
    'sidebar_submenu' => null,
    'wheader' => [
        'header_title' => 'Produk Serial Number: Edit Data',
        'header_breadcrumb' => [
            [
                'title' => 'Dashboard',
                'is_active' => false,
...
@section('content')
<form class="card" method="POST" action="{{ route('adm.product.serial-number.update', [$product->uuid, $data->uuid]) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('serial_number') is-invalid @enderror" value="{{ $data->serial_number }}" id="input-serial_number" name="serial_number" placeholder="Serial Number dari Produk {{ $product->name }}">
            @error('serial_number')
            <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            <label>Catatan</label>
            <textarea class="ckeditor d-none @error('note') is-invalid @enderror" name="note" id="input-note" placeholder="Catatan mengenai Serial Number pada Produk terkait akan berada disini...">{!! $data->note !!}</textarea>
            @error('note')
            <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
