@extends('layouts.adm.app', [
    'wsecond_title' => 'Staff: Tambah Baru',
    'sidebar_menu' => 'staff',
    'sidebar_submenu' => null,
    'wheader' => [
        'header_title' => 'Staff: Tambah Baru',
        'header_breadcrumb' => [
            [
                'title' => 'Dashboard',
                'is_active' => false,
...
@section('content')
<form class="card" method="POST" action="{{ route('adm.staff.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="input-name" placeholder="Nama Staff" value="{{ old('name') }}">
            @error('name')
            <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="input-username" placeholder="Username Staff" value="{{ old('username') }}">
            @error('username')
            <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="input-email" placeholder="Email Staff" value="{{ old('email') }}">
            @error('email')
            <span class="invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            <div class="custom-control custom-switch">
                <input type="checkbox" class="custom-control-input" name="is_active" id="input-is_active">
